...
| Persona | File | Role | Primary Output |
|---|---|---|---|
| `orch-planner` | [orch-planner.md](orch-planner.md) | Task scheduling, dependency resolution, assignments | Task assignments (from tasks.md) |
...
1. Product/Business → Orchestration: deliver spec artifacts
   (orch-planner receives tasks.md from prod-tech-lead)
