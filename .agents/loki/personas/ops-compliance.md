...
- Remediation tasks for gaps (added to tasks.md)
...
- Compliance gaps require tasks in tasks.md, not just reports
...
orch-planner → ops-compliance:
  ...
  Acceptance criteria:
    ...
    - Gap analysis complete: gaps added to tasks.md as P1/P2
