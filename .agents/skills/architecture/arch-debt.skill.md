...
7. **Create tasks in tasks.md** (15-min rule applies to architecture work too)
...
## Output Format
Architecture debt report + prioritized migration roadmap + ADR for major changes + tasks in tasks.md.
