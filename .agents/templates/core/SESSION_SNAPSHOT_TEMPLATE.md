...
<!-- Store in: .agents/loki/memory/episodic/SESSION_SNAPSHOT/S[XX]_[phase].md -->
...
| tasks.md | [N/M tasks done] | tasks.md | [N] TODO, [N] IN_PROGRESS, [N] DONE, [N] BLOCKED |
...
- [Key facts in loki/memory/semantic/ relevant to continuing work]
