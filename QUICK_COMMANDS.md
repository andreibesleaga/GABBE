...
|---|---|---|
| **Initialize Kit** | `python3 init.py` | Runs the setup wizard to configure the kit, wire your AI agents (Claude, Cursor, Gemini), and generate `BOOTSTRAP_MISSION.md` |
...
| Command | Description |
|---|---|
| `gabbe init` | Initializes the SQLite database (run after `init.py`). |
| `gabbe sync` | Bidirectional sync between `TASKS.md` and SQLite DB. |
