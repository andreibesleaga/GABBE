...
| **GitHits** | Navigate open-source dependency source/docs (no clone, no key) |
...
Config: `templates/core/MCP_CONFIG_TEMPLATE.json` · Full guide: [MCP_CONFIGURATIONS.md](docs/MCP_CONFIGURATIONS.md)
