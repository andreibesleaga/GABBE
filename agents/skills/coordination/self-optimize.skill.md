...
## Constraints
- Optimize quality AND cost together — never sacrifice a quality/security gate, the core SDLC (S01–S10, within the full S00–S13 lifecycle), or HITL escalation to save tokens (Article X).
