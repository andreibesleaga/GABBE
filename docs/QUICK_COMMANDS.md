...
| `gabbe runs [--status STATUS] [--limit N]` | List recent agent runs with status, cost, and timestamps. |
...
| `gabbe setup` | Interactive install wizard (also `npx gabbe-kit init` for a Python-independent install). |
